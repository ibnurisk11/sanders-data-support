...
# Membaca data
df_personal_loan = pd.read_csv("data/daily-report-personal-20250410.csv")
...
loan_tenor = ["Semua Tenor"] + list(df_personal_loan["Tenor"].dropna().unique())
...
filtered_df = filter_data(
    df_personal_loan, selected_company, selected_marketing, selected_status, selected_tenor, selected_dates
)
